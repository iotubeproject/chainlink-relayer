...
func (_ShadowAggregator *ShadowAggregatorCaller) IsOwner(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _ShadowAggregator.contract.Call(opts, &out, "isOwner")
...
//
// Solidity: function isOwner() view returns(bool)
func (_ShadowAggregator *ShadowAggregatorSession) IsOwner() (bool, error) {
	return _ShadowAggregator.Contract.IsOwner(&_ShadowAggregator.CallOpts)
}

// IsOwner is a free data retrieval call binding the contract method 0x8f32d59b.
//
// Solidity: function isOwner() view returns(bool)
func (_ShadowAggregator *ShadowAggregatorCallerSession) IsOwner() (bool, error) {
	return _ShadowAggregator.Contract.IsOwner(&_ShadowAggregator.CallOpts)
}
...
func (_ShadowAggregator *ShadowAggregatorTransactor) TransferOwnership(opts *bind.TransactOpts, newOwner common.Address) (*types.Transaction, error) {
	return _ShadowAggregator.contract.Transact(opts, "transferOwnership", newOwner)
}

// TransferOwnership is a paid mutator transaction binding the contract method 0xf2fde38b.
//
// Solidity: function transferOwnership(address newOwner) returns()
func (_ShadowAggregator *ShadowAggregatorSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
	return _ShadowAggregator.Contract.TransferOwnership(&_ShadowAggregator.TransactOpts, newOwner)
}

// TransferOwnership is a paid mutator transaction binding the contract method 0xf2fde38b.
//
// Solidity: function transferOwnership(address newOwner) returns()
func (_ShadowAggregator *ShadowAggregatorTransactorSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
	return _ShadowAggregator.Contract.TransferOwnership(&_ShadowAggregator.TransactOpts, newOwner)
}
...
func (_ShadowAggregator *ShadowAggregatorFilterer) FilterOwnershipTransferred(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*ShadowAggregatorOwnershipTransferredIterator, error) {
	...
	logs, sub, err := _ShadowAggregator.contract.FilterLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)
func (_ShadowAggregator *ShadowAggregatorFilterer) WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *ShadowAggregatorOwnershipTransferred, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ShadowAggregator.contract.WatchLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
